...
class ExampleEndpoint extends Endpoint {
  ...
  Future<String> hello(Session session, String name) async {
    final smpt = gmail('crazyysasha@gmail.com', "qilv aviv aegy odgo");

    final message = Message()
      ..from = Address('crazyysasha@gmail.com')
      ..subject = 'Hello, $name!'
      ..recipients.add(Address(name));
    final report = await send(message, smpt);
    print(report);
